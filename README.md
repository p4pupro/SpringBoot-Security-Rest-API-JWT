 ...
 * Example of resource accessible to all authenticated users:  http://localhost:8080/springjwt/ciudades
 * Example of resource accessible to only an admin user:  http://localhost:8080/springjwt/usuarios
